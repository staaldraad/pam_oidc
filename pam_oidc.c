...
// natively create a method with 'const char**' as an argument.
int pam_sm_authenticate_go(pam_handle_t *pamh, int flags, int argc,
                           char **argv);
int pam_sm_authenticate(pam_handle_t *pamh, int flags, int argc,
                        const char **argv) {
  // pam_sm_authenticate_go does not modify argv, only copies them to Go
  // strings.
...
char *argv_i(char **argv, int i) { return argv[i]; }
